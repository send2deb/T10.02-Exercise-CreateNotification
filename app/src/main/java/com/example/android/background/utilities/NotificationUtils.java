...
public class NotificationUtils {
    ...
    private static final int WATER_REMIDER_NOTIFICATION_ID = 100;
    private static final String NOTIFICATION_CHANNEL_ID = "drink_water_remider_notification_channel_id";
    ...
    public static void remindUserBecauseCharging (Context context) {
        ...
        notificationManager.notify(WATER_REMIDER_NOTIFICATION_ID, builder.build());
    }
